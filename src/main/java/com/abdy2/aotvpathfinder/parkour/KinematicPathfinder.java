...
public class KinematicPathfinder {
     ...
     */
    public KinematicPathfinder(Level world, BlockPos goalPos) {
        this.world = world;
    ...
    private boolean hasGroundAhead(ParkourNode current, float yaw) {
        ...
        if (!aboveShape.isEmpty()) {
            double aboveHeight = aboveShape.max(net.minecraft.core.Direction.Axis.Y);
     ...
     * Finds a parkour path from start to goal.
     */
    public static List<ParkourNode> findParkourPath(Level world, Vec3 startPos,
     ...
     */
    public static List<ParkourNode> findParkourPath(Level world, BlockPos startBP,
                                                      BlockPos goalBP, float yaw) {
        Vec3 startPos = new Vec3(startBP.getX() + 0.5, startBP.getY(), startBP.getZ() + 0.5);
     ...
     */
    public static List<ParkourNode> findParkourPath(Level world, double startX, double startY, double startZ,
                                                      BlockPos goalPos, float yaw, boolean sprinting) {
        KinematicPathfinder pathfinder = new KinematicPathfinder(world, goalPos);
