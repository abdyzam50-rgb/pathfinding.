...
public class PathNode {
    ...
    public PathNode(BlockPos pos, PathNode parent, Type type) {
        this.pos = pos;
        this.precisePos = new Vec3(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5);
        this.parent = parent;
        this.type = type;
    ...
    public PathNode(BlockPos pos, Vec3 precisePos, PathNode parent, Type type) {
        this.pos = pos;
    ...
    public PathNode(BlockPos pos, Vec3 precisePos, PathNode parent, Type type, BlockPos interactPos) {
        this.pos = pos;
        this.precisePos = precisePos;
        this.parent = parent;
        this.type = type;
